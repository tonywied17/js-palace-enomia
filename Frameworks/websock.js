...
} else if ( window.MozWebSocket && !window.WEB_SOCKET_FORCE_FLASH )
{
    ...
    (function ()
    {
        window.WEB_SOCKET_SWF_LOCATION = Util.get_include_uri() + "flash/WebSocketMain.swf";
        ...
        Util.load_scripts(["flash/swfobject.js","flash/web_socket.js"]);
    }());
}
...
function Websock()
{
	...
	function rQwait(msg, num, goback)
	{
		...
		if (rQlen < num)
		{
			...
			Util.Debug("   waiting for " + (num-rQlen) + " " + msg + " byte(s)");
	...
	function init(protocols)
	{
	   ...
	   {
			//"ws://localhost:17523"
		  //  var sckTest = 'ws://192.168.0.35:9999/';
		   // if (bt && ('binaryType' in (new WebSocket(sckTest)))) {
